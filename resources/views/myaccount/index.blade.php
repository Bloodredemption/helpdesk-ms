...
@section('container-fluid')
    <div class="container-fluid">
        <div class="card-title fw-semibold mb-2">
            <span style="display: inline-block; vertical-align: middle;">My Account</span>
        </div>
        
        <h6 class="font-weight-normal mb-0">Account Information. <span style="color: red;">*</span></h6>
        <br>
        @if ($errors->any())
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('myaccount.updatePass', $user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
